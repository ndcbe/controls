...
| 10 - 11 | Advanced topics and Predictive Control |
| 12 - 13 | Team Project Workshops and preparation|
...
## DeBartolo 228 Computer Lab

The computers in DeBartolo 228 have Anaconda installed. The first time you use a specific machine, you will need to create the `controls` environment and install the packages using the Windows instructions above. Here is a video walking through the students (no audio):
